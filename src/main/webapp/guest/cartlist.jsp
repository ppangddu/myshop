...
<table style="width: 95%">
  ...
  <% 	  
	...
	/*
	Enumeration enu = hCart.keys();  // Map 타입의 컬렉션을 읽어 Enumeration 객체를 이용해 반복처리
	...
	*/
	...
	// for-each loop와 Map.Entry를 사용해 Hashtable의 키-값 쌍을 반복 처리
	// hCart.entrySet()은 Set을 반환하여 for-each loop에서 사용한다.
	// Map.Entry : Map에 저장된 모든 키-값 쌍을 각각의 키-값을 갖고있는 하나의 객체로 얻는다.
	// entry라는 객체 변수는 HashMap에 대한 키-값 쌍을 하나의 객체로 갖고 있어
